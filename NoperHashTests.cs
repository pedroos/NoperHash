...
public static partial class Tests {
    public static void RunGeneric() {
        ...
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s01), 0.37965870745378555, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s02), 0.49196617766541745, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s03), 0.6001859386298001, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s04), 0.5062227481033681, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s05), 0.5498883933485951, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s06), 0.6145925169648433, Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s07), 0.0, Eps));
        ...
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s08), 0, Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s09), 0, Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s08), NoperHash.Calc(s09), Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s10), NoperHash.Calc(s11), Eps));
        ...
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s12), NoperHash.Calc(s13), Eps));
        ...
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s14), NoperHash.Calc(s15), Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s14), NoperHash.Calc(s16), Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s14), NoperHash.Calc(s17), Eps));
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s14), NoperHash.Calc(s18), Eps));
        ...
        WriteLine(!NoperHash.Approximately(NoperHash.Calc(s19), NoperHash.Calc(s20), Eps));
        WriteLine(NoperHash.Approximately(NoperHash.Calc(s19), NoperHash.Calc(s21), Eps));
    }
}
